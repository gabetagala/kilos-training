...
export const EQUIPMENT_TIERS = [
  {
    id: 'full-gym',
    label: 'Full Gym',
    description: 'All machines · Fitness First, UFC Gym, Kerry Sports',
  },
  {
    id: 'home-dumbbells',
    label: 'Home + Dumbbells',
    description: 'Dumbbells, bench, optional pull-up bar',
  },
  {
    id: 'barbell-rack',
    label: 'Barbell + Rack',
    description: 'Home power rack, no cables or machines',
  },
  {
    id: 'bands',
    label: 'Resistance Bands',
    description: 'Bands and door anchor only',
  },
  {
    id: 'bodyweight',
    label: 'Bodyweight',
    description: 'No equipment · parks, hotels, home',
  },
];
...
export const EQUIPMENT_SUBSTITUTIONS = {
  ...
  'Push-Up': {
    'full-gym': 'Push-Up',
    'ph-local': 'Push-Up',
    'home-dumbbells': 'Push-Up',
    'barbell-rack': 'Push-Up',
    bands: 'Push-Up',
    bodyweight: 'Push-Up',
  },
  'Diamond Push-Up': {
    'full-gym': 'Diamond Push-Up',
    'ph-local': 'Diamond Push-Up',
    'home-dumbbells': 'Diamond Push-Up',
    'barbell-rack': 'Diamond Push-Up',
    bands: 'Diamond Push-Up',
    bodyweight: 'Diamond Push-Up',
  },
  ...
  'Inverted Row': {
    ...
    'ph-local': 'Inverted Row',
    'home-dumbbells': 'Inverted Row',
    'barbell-rack': 'Inverted Row',
    bands: 'Inverted Row',
    bodyweight: 'Inverted Row',
  },
  'Dumbbell Pullover': {
    'full-gym': 'Dumbbell Pullover',
    'ph-local': 'Dumbbell Pullover',
    'home-dumbbells': 'Dumbbell Pullover',
    'barbell-rack': 'Dumbbell Pullover',
    bands: 'Band Pullover',
    bodyweight: 'Inverted Row',
  ...
  'Pike Push-Up': {
    'full-gym': 'Pike Push-Up',
    'ph-local': 'Pike Push-Up',
    'home-dumbbells': 'Pike Push-Up',
    'barbell-rack': 'Pike Push-Up',
    bands: 'Pike Push-Up',
    bodyweight: 'Pike Push-Up',
  },
  'Landmine Press': {
    'full-gym': 'Landmine Press',
    'ph-local': 'Landmine Press',
    'home-dumbbells': 'Dumbbell Overhead Press',
    'barbell-rack': 'Landmine Press',
    bands: 'Band Overhead Press',
    bodyweight: 'Pike Push-Up',
  },
  ...
  'Hammer Curl': {
    'full-gym': 'Hammer Curl',
    'ph-local': 'Hammer Curl',
    'home-dumbbells': 'Hammer Curl',
    'barbell-rack': 'Hammer Curl',
    bands: 'Band Hammer Curl',
    bodyweight: 'Chin-Up',
  },
  'Spider Curl': {
    'full-gym': 'Spider Curl',
    'ph-local': 'Spider Curl',
    'home-dumbbells': 'Incline Dumbbell Curl',
    'barbell-rack': 'Spider Curl',
    bands: 'Band Curl',
    bodyweight: 'Chin-Up',
  },
  'Preacher Curl (EZ Bar)': {
    'full-gym': 'Preacher Curl (EZ Bar)',
    'ph-local': 'Preacher Curl (EZ Bar)',
    'home-dumbbells': 'Incline Dumbbell Curl',
    'barbell-rack': 'Barbell Curl',
    bands: 'Band Curl',
    bodyweight: 'Chin-Up',
  ...
  'Chin-Up': {
    'full-gym': 'Chin-Up',
    'ph-local': 'Chin-Up',
    'home-dumbbells': 'Chin-Up',
    'barbell-rack': 'Chin-Up',
    bands: 'Band Curl',
    bodyweight: 'Chin-Up',
  },
  ...
  'Tricep Dips (Bench)': {
    'full-gym': 'Tricep Dips (Bench)',
    'ph-local': 'Tricep Dips (Bench)',
    'home-dumbbells': 'Tricep Dips (Bench)',
    'barbell-rack': 'Tricep Dips (Bench)',
    bands: 'Diamond Push-Up',
    bodyweight: 'Diamond Push-Up',
  },
  ...
  'Step-Up': {
    'full-gym': 'Step-Up',
    'ph-local': 'Step-Up',
    'home-dumbbells': 'Step-Up',
    'barbell-rack': 'Step-Up',
    bands: 'Step-Up',
    bodyweight: 'Step-Up',
  },
  'Dumbbell Leg Curl': {
    'full-gym': 'Dumbbell Leg Curl',
    'ph-local': 'Dumbbell Leg Curl',
    'home-dumbbells': 'Dumbbell Leg Curl',
    'barbell-rack': 'Dumbbell Leg Curl',
    bands: 'Band Leg Curl',
    bodyweight: 'Nordic Hamstring Curl',
  ...
  'Reverse Lunge': {
    'full-gym': 'Reverse Lunge',
    'ph-local': 'Reverse Lunge',
    'home-dumbbells': 'Reverse Lunge',
    'barbell-rack': 'Reverse Lunge',
    bands: 'Band Reverse Lunge',
    bodyweight: 'Reverse Lunge',
  },
  'Glute Bridge': {
    'full-gym': 'Glute Bridge',
    'ph-local': 'Glute Bridge',
    'home-dumbbells': 'Glute Bridge',
    'barbell-rack': 'Glute Bridge',
    bands: 'Glute Bridge',
    bodyweight: 'Glute Bridge',
  },
  'Single-Leg Calf Raise': {
    'full-gym': 'Single-Leg Calf Raise',
    'ph-local': 'Single-Leg Calf Raise',
    'home-dumbbells': 'Single-Leg Calf Raise',
    'barbell-rack': 'Single-Leg Calf Raise',
    bands: 'Single-Leg Calf Raise',
    bodyweight: 'Single-Leg Calf Raise',
  },
  ...
  'Side Plank': {
    'full-gym': 'Side Plank',
    'ph-local': 'Side Plank',
    'home-dumbbells': 'Side Plank',
    'barbell-rack': 'Side Plank',
    bands: 'Side Plank',
    bodyweight: 'Side Plank',
  },
  'Dragon Flag': {
    'full-gym': 'Dragon Flag',
    'ph-local': 'Dragon Flag',
    'home-dumbbells': 'Dragon Flag',
    'barbell-rack': 'Dragon Flag',
    bands: 'Plank',
    bodyweight: 'Dragon Flag',
  },
  'Lying Leg Raise': {
    'full-gym': 'Lying Leg Raise',
    'ph-local': 'Lying Leg Raise',
    'home-dumbbells': 'Lying Leg Raise',
    'barbell-rack': 'Lying Leg Raise',
    bands: 'Lying Leg Raise',
    bodyweight: 'Lying Leg Raise',
  },
};
...
export const INJURY_TYPES = [
  {
    id: 'lower-back',
    label: 'Lower Back',
    description: 'Pain or tightness in the lumbar region',
  },
  {
    id: 'knee',
    label: 'Knee Pain',
    description: 'Anterior knee pain, tendinopathy, or meniscus issues',
  },
  {
    id: 'shoulder',
    label: 'Shoulder',
    description: 'Impingement, rotator cuff, or AC joint issues',
  },
  {
    id: 'wrist',
    label: 'Wrist',
    description: 'Wrist pain, tendinitis, or limited extension',
  },
  {
    id: 'elbow',
    label: 'Elbow',
    description: "Tennis elbow, golfer's elbow, or joint pain",
  },
  {
    id: 'hip-flexor',
    label: 'Hip Flexor',
    description: 'Hip flexor tightness, strain, or anterior hip pain',
  },
  {
    id: 'neck',
    label: 'Neck',
    description: 'Cervical pain, tightness, or recent strain',
  },
];
...
export const INJURY_SUBSTITUTIONS = {
  'lower-back': {
    ...
    notes:
      'Keep spine neutral. Avoid loading under fatigue. Prioritise hip hinge over spinal extension.',
  },
  knee: {
    substitute: {
    ...
    notes:
      'Limit knee flexion past 90° under load. Avoid valgus. Prioritise hip-dominant patterns.',
  },
  shoulder: {
    substitute: {
    ...
    notes:
      'Avoid internal rotation under load above 90°. Add face pulls as therapeutic work.',
  },
  wrist: {
    substitute: {
  ...
  'hip-flexor': {
    ...
    notes:
      'Prioritise posterior chain. Add hip flexor stretching between sets.',
  },
  neck: {
    substitute: {
      'Upright Row (Cable)': 'Dumbbell Lateral Raise',
    ...
    notes:
      'Avoid cervical compression. If pain is acute or radiating, consult a doctor first.',
  },
};
...
export function resolveExercise(exerciseName, profile) {
  ...
  for (const injuryId of injuries || []) {
    ...
    if (sub)
      return { name: sub, original: exerciseName, reason: 'injury', injuryId };
  }
  ...
  const effectiveTier =
    equipmentTier === 'ph-local' ? 'full-gym' : equipmentTier;
